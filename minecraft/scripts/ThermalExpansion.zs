...
recipes.addShaped(<ThermalExpansion:Cell:2>, [[null, <IC2:itemPartCircuit>, null], [tubeBronze, <ThermalExpansion:Frame:5>, tubeBronze], [null, <ThermalExpansion:material:3>, null]]);recipes.addShaped(<ThermalExpansion:Cell:3>, [[null, <ore:circuitAdvanced>, null], [tubeDiamond, <ThermalExpansion:Frame:7>, tubeDiamond], [null, <EnderIO:itemBasicCapacitor:1>, null]]);
